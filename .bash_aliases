...
alias mciskip='rainbow --config=mvn3 -- mvn clean install -DskipTests=true'
...
alias mced='rainbow --config=mvn3 -- mvn eclipse:clean eclipse:eclipse -DdownloadJavadocs=true -DdownloadSources=true'
alias mi='rainbow --config=mvn3 -- mvn install'
alias miskip='rainbow --config=mvn3 -- mvn install -Dmaven.test.skip=true'
